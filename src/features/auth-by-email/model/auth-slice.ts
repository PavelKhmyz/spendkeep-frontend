...
import { LoginDto, authorizationApi } from 'src/shared/api/authorization';
import { RegistrationDto, registrationApi } from 'src/shared/api/registration';
...
export const userLogin = createAsyncThunk('web-api/login', async (params: LoginDto) => {
  return await authorizationApi.login(params);
});

export const userRegistration = createAsyncThunk('web-api/registration', async (params: RegistrationDto) => {
